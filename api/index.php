...
<html>
<head>
	<title>TUGAstream Player</title>
	<meta name="robots" content="noindex">
	<link rel="shortcut icon" href="assets/img/favicon.ico" type="image/x-icon" />
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.0/sweetalert.min.js"></script>
	<script type="text/javascript" src="https://ssl.p.jwpcdn.com/player/v/8.22.2/jwplayer.js"></script>
...
if ($data != '') {
	...
	$data = 'var player = jwplayer("cf-player");
				player.setup({
					...
					autostart: false,
					preload: "auto",
					aboutlink: "https://www.tugastream.club",
					abouttext: "TUGAstream",
					image: "'.$poster.'",
					captions: {
						color: "#ffffff",
						backgroundOpacity: 0,

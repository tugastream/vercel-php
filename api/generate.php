...
<head>
	...
	<title>Generator TUGAstream Player</title>
...
<body>
	...
	<footer class="footer">
		<p class="text-center text-white">Copyleft &copy; <?php echo date('Y') ?> <a href="https://www.tugastream.club" title="TUGAstream" target="_blank">TUGAstream</a>. All rights reserved.</p>
	</footer>
</body>
</html>
